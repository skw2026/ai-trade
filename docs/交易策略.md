...
- S5 可通过 `execution.candidate_probe_*` 打开受控小额 maker 探针：仅在空仓、无同币种在途净仓位订单、普通策略无开仓意图、候选趋势强度达标时生成小额 Entry，并继续走成本门、WAL、OMS、保护单和对账链路；它用于收集真实 live execution 样本，不等同于放开完整 TREND 主链。
