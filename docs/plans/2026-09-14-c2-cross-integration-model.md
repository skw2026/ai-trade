...
同日更新：新增独立的[研究验收与退出分类层](../reviews/2026-09-14-c2-acceptance-and-exit-evidence.md)，按实际复算输出研究 PASS/FAIL、退出约束及历史证明能力缺口；本参考计算器的固定资格边界不改。研究工作流校验包已扩至 10 份代码文件，原“六文件”描述保留为初版实现状态。
