...
PATH_LABEL_BASE_SOURCES = [
    ...
    ("ret_24", "path_label_return"),
    ("ret_36", "path_label_return"),
    ("ret_72", "path_label_return"),
    ("ema_diff", "path_label_trend"),
    ("ema_diff_96", "path_label_trend"),
    ("mom_12", "path_label_momentum"),
    ("mom_48", "path_label_momentum"),
    ("mom_96", "path_label_momentum"),
    ("ret_3_minus_ret_12", "path_label_momentum_acceleration"),
    ("ret_12_minus_ret_48", "path_label_momentum_acceleration"),
    ("zscore_48", "path_label_reversion"),
    ("zscore_96", "path_label_reversion"),
    ("vol_ratio_12_48", "path_label_volatility"),
    ("vol_ratio_48_96", "path_label_volatility"),
    ("body_pct", "path_label_candle_shape"),
    ("upper_wick_pct", "path_label_candle_shape"),
    ("lower_wick_pct", "path_label_candle_shape"),
    ("close_pos_in_range", "path_label_candle_shape"),
    ("volume_zscore_48", "path_label_volume"),
    ("volume_ratio_12_48", "path_label_volume"),
    ("signed_volume_pressure", "path_label_volume"),
    ...
    with path.open("r", encoding="utf-8") as fp:
        ...
        for raw in reader:
            ...
            for column in FEATURE_VALUE_COLUMNS:
                row[column] = safe_float(raw.get(column), math.nan)
            rows.append(row)
...
def candidate_specs() -> List[Dict[str, Any]]:
    return [
        ...
        {"name": "mom96_follow", "family": "long_horizon_momentum", "source": "mom_96", "mode": "follow"},
        {"name": "mom96_inverse", "family": "long_horizon_momentum", "source": "mom_96", "mode": "inverse"},
        ...
        {"name": "ret24_follow", "family": "long_horizon_return", "source": "ret_24", "mode": "follow"},
        {"name": "ret24_inverse", "family": "long_horizon_return", "source": "ret_24", "mode": "inverse"},
        {"name": "ret72_follow", "family": "long_horizon_return", "source": "ret_72", "mode": "follow"},
        {"name": "ret72_inverse", "family": "long_horizon_return", "source": "ret_72", "mode": "inverse"},
        {"name": "ret1_inverse", "family": "legacy_return", "source": "ret_1", "mode": "inverse"},
        {
            "name": "momentum_accel_follow",
            "family": "momentum_acceleration",
            "source": "ret_3_minus_ret_12",
            "mode": "follow",
        },
        {
            "name": "momentum_accel_inverse",
            "family": "momentum_acceleration",
            "source": "ret_3_minus_ret_12",
            "mode": "inverse",
        },
        {
            "name": "momentum_decay_follow",
            "family": "momentum_acceleration",
            "source": "ret_12_minus_ret_48",
            "mode": "follow",
        },
        {
            "name": "momentum_decay_inverse",
            "family": "momentum_acceleration",
            "source": "ret_12_minus_ret_48",
            "mode": "inverse",
        },
        ...
        {"name": "zscore96_follow", "family": "long_horizon_reversion", "source": "zscore_96", "mode": "follow"},
        {"name": "zscore96_inverse", "family": "long_horizon_reversion", "source": "zscore_96", "mode": "inverse"},
        {"name": "ema96_follow", "family": "long_horizon_trend", "source": "ema_diff_96", "mode": "follow"},
        {"name": "ema96_inverse", "family": "long_horizon_trend", "source": "ema_diff_96", "mode": "inverse"},
        {
        ...
        {
            "name": "vol_ratio_12_48_follow",
            "family": "volatility_state",
            "source": "vol_ratio_12_48",
            "mode": "follow",
        },
        {
            "name": "vol_ratio_12_48_inverse",
            "family": "volatility_state",
            "source": "vol_ratio_12_48",
            "mode": "inverse",
        },
        {
            "name": "vol_ratio_48_96_follow",
            "family": "volatility_state",
            "source": "vol_ratio_48_96",
            "mode": "follow",
        },
        {
            "name": "vol_ratio_48_96_inverse",
            "family": "volatility_state",
            "source": "vol_ratio_48_96",
            "mode": "inverse",
        },
        {"name": "body_follow", "family": "candle_shape", "source": "body_pct", "mode": "follow"},
        {"name": "body_inverse", "family": "candle_shape", "source": "body_pct", "mode": "inverse"},
        {
            "name": "lower_wick_follow",
            "family": "candle_shape",
            "source": "lower_wick_pct",
            "mode": "follow",
        },
        {
            "name": "lower_wick_inverse",
            "family": "candle_shape",
            "source": "lower_wick_pct",
            "mode": "inverse",
        },
        {
            "name": "upper_wick_follow",
            "family": "candle_shape",
            "source": "upper_wick_pct",
            "mode": "follow",
        },
        {
            "name": "upper_wick_inverse",
            "family": "candle_shape",
            "source": "upper_wick_pct",
            "mode": "inverse",
        },
        {
            "name": "close_pos_follow",
            "family": "candle_shape",
            "source": "close_pos_in_range",
            "mode": "follow",
        },
        {
            "name": "close_pos_inverse",
            "family": "candle_shape",
            "source": "close_pos_in_range",
            "mode": "inverse",
        },
        {
            "name": "volume_zscore_follow",
            "family": "volume_pressure",
            "source": "volume_zscore_48",
            "mode": "follow",
        },
        {
            "name": "volume_zscore_inverse",
            "family": "volume_pressure",
            "source": "volume_zscore_48",
            "mode": "inverse",
        },
        {
            "name": "volume_ratio_follow",
            "family": "volume_pressure",
            "source": "volume_ratio_12_48",
            "mode": "follow",
        },
        {
            "name": "volume_ratio_inverse",
            "family": "volume_pressure",
            "source": "volume_ratio_12_48",
            "mode": "inverse",
        },
        {
            "name": "signed_volume_pressure_follow",
            "family": "volume_pressure",
            "source": "signed_volume_pressure",
            "mode": "follow",
        },
        {
            "name": "signed_volume_pressure_inverse",
            "family": "volume_pressure",
            "source": "signed_volume_pressure",
            "mode": "inverse",
        },
