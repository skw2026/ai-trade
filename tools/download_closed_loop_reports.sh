...
fetch_report "${REMOTE_BASE}/cross_venue_capture_report.json" ".artifacts/cross_venue_capture_report.json" "cross_venue_capture_report" "json"
fetch_report "${REMOTE_BASE}/cross_venue_information_set_experiment.json" ".artifacts/cross_venue_information_set_experiment.json" "cross_venue_information_set_experiment" "json"
