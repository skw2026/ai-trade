...
def compute_replay_summary(runs: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    if latest_item is None or latest_replay is None:
        return {
            ...
            "source_symbol": None,
            "source_symbols": {},
            "source_symbol_matches_target": None,
            "real_market_replay": None,
            "symbol": None,
            "symbols": [],
            "segments_ran": 0,
    ...
    return {
        ...
        "source_symbol": latest_replay.get("source_symbol"),
        "source_symbols": latest_replay.get("source_symbols", {}),
        "source_symbol_matches_target": latest_replay.get("source_symbol_matches_target"),
        "real_market_replay": latest_replay.get("real_market_replay"),
        "symbol": latest_replay.get("symbol"),
        "symbols": latest_replay.get("symbols", []),
